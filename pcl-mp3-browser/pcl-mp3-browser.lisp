...
;; This seems to be a point of weakness.  If the mp3 source doesn't have at least
;; this many items to list, I get an error.
(defparameter *r* 25)
...
;; Bad practice here, as we are using a non-public symbol from net.aserve.  No
;; guarantees this will continue working.
...
(define-url-function browse (request (what keyword :genre) genre artist album (random integer))
